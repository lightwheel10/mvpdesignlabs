...
const testimonials = [
  {
    ...
    content: "MVP Forge didn't just build our product; they transformed our vision into reality. Their approach to development and attention to user experience helped us secure our first round of funding within weeks of launch.",
  ...
  },
  {
    ...
    content: "What sets MVP Forge apart is their strategic thinking. They challenged our assumptions, refined our concept, and delivered a product that exceeded market expectations. The ROI has been exceptional.",
  ...
  },
  {
    ...
    content: "Working with MVP Forge felt like having a technical co-founder. Their expertise in both business and technology helped us pivot quickly when needed and scale efficiently as we grew.",
  ...
  },
  {
    ...
    content: "In the highly regulated healthcare space, MVP Forge's attention to security and compliance while maintaining rapid development pace was impressive. They helped us launch our platform 2 months ahead of schedule.",
      ...
      <div className="container relative">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 relative h-[400px] lg:h-[600px]">
            <div className="absolute inset-0 rounded-3xl overflow-hidden bg-background/5">
